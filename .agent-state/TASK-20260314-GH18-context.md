...
\n# TASK SPEC\n{
  "task_id": "TASK-20260314-GH18",
  "title": "feat(skill-registry): API для оценки скилла (1-5 звёзд)",
  "description": "GitHub Issue #18: feat(skill-registry): API для оценки скилла (1-5 звёзд)\n\nДобавить endpoint для оценки скилла пользователем.\n\n## Сервис\nservices/skill-registry/\n\n## Файл\nsrc/routes/skills.ts\n\n## Что добавить\n\nPOST /api/v1/marketplace/:id/rate\nBody: { rating: number (1-5), comment?: string }\nHeaders: Authorization Bearer (userId из токена или x-user-id хедер)\n\nЛогика:\n1. Проверить что rating от 1 до 5\n2. Upsert в таблицу skill_reviews: { skillId, userId, rating, comment, createdAt }\n3. Пересчитать ratingAvg в таблице skills: UPDATE skills SET ratingAvg = (SELECT AVG(ra",
  "service": "skill-registry",
  "type": "feat",
  "priority": "medium",
  "file_scope": [],
  "acceptance_criteria": [
    "Проблема из issue #18 устранена",
  ...
  "timeout_minutes": 30,
  "cost_budget_usd": 2,
  "created_at": "2026-03-14T15:01:05.868Z",
  "github_issue": {
    "number": 18,
    "url": "https://github.com/Rivega42/grandhub-feedback/issues/18",
    "author": "Rivega42"
  }
