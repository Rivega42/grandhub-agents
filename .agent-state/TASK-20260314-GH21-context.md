...
\n# TASK SPEC\n{
  "task_id": "TASK-20260314-GH21",
  "title": "feat(api-gateway): расширить /health — добавить версию и статус сервисов",
  "description": "GitHub Issue #21: feat(api-gateway): расширить /health — добавить версию и статус сервисов\n\nСделать /health endpoint более информативным.\n\n## Сервис\nservices/api-gateway/\n\n## Файл\nsrc/routes/health.ts или src/index.ts\n\n## Что сделать\n\nТекущий /health возвращает { status: ok }.\n\nРасширить до:\n{\n  status: ok | degraded,\n  version: string (из package.json),\n  uptime: number (секунды),\n  timestamp: string (ISO),\n  services: {\n    auth: ok | unreachable,\n    assistantRuntime: ok | unreachable,\n    skillRegistry: ok | unreachable\n  }\n}\n\nДля проверки каждого сервиса — делать HTTP GET на их /h",
  "service": "api-gateway",
  "type": "feat",
  "priority": "medium",
  "file_scope": [],
  "acceptance_criteria": [
    "Проблема из issue #21 устранена",
  ...
  "github_issue": {
    "number": 21,
    "url": "https://github.com/Rivega42/grandhub-feedback/issues/21",
    "author": "Rivega42"
  }
