...
\n# TASK SPEC\n{
  "task_id": "TASK-20260314-GH7",
  "title": "feat(telegram-bot): добавить команду /newskill для создания скиллов",
  "description": "GitHub Issue #7: feat(telegram-bot): добавить команду /newskill для создания скиллов\n\nПользователь должен мочь создать свой L0 Prompt Skill прямо в боте.\n\n## Флоу\n\n1. /newskill → Опиши что должен делать скилл\n2. Пользователь описывает → бот генерирует system_prompt через LLM\n3. Показывает превью: имя, эмодзи, описание, system_prompt\n4. Inline кнопки: [✅ Сохранить] [✏️ Изменить] [🔄 Перегенерировать]\n5. После сохранения: [🔒 Приватный] [🌐 Опубликовать]\n6. Если публичный → status=review (пока автоапрув)\n\n## Файлы\n- services/telegram-bot/src/commands/newskill.ts (создать)\n- service",
  "service": "telegram-bot",
  "type": "feat",
  "priority": "medium",
  "file_scope": [],
  "acceptance_criteria": [
    "Проблема из issue #7 устранена",
  ...
  "github_issue": {
    "number": 7,
    "url": "https://github.com/Rivega42/grandhub-feedback/issues/7",
    "author": "Rivega42"
  }
