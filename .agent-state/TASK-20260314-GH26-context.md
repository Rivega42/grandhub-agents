...
\n# TASK SPEC\n{
  "task_id": "TASK-20260314-GH26",
  "title": "feat(telegram-bot): команда /new — новые скиллы этой недели",
  "description": "GitHub Issue #26: feat(telegram-bot): команда /new — новые скиллы этой недели\n\nДобавить команду /new которая п��казывает скиллы добавленные за последние 7 дней.\n\n## Сервис\nservices/telegram-bot/\n\n## Файлы\n- src/commands/new-skills.ts — новый файл\n- src/bot.ts — зарегистрировать /new\n\n## Что сделать\n\n/new делает запрос к marketplace API:\nGET /api/v1/marketplace?sort=newest&limit=5\n\nПоказывает список новых скиллов с кнопками [Установить] как в /skills.\nЕсли новых нет — сообщение Новых скиллов на этой неделе пока нет. Загляни в /skills.\n\nВ marketplace API добавить поддержку ?",
  "service": "telegram-bot",
  "type": "feat",
  "priority": "medium",
  "file_scope": [],
  "acceptance_criteria": [
    "Проблема из issue #26 устранена",
  ...
  "timeout_minutes": 30,
  "cost_budget_usd": 2,
  "created_at": "2026-03-14T15:36:10.425Z",
  "github_issue": {
    "number": 26,
    "url": "https://github.com/Rivega42/grandhub-feedback/issues/26",
    "author": "Rivega42"
  }
