...
\n# TASK SPEC\n{
  "task_id": "TASK-20260314-GH8",
  "title": "feat(skill-registry): REST API для маркетплейса скиллов",
  "description": "GitHub Issue #8: feat(skill-registry): REST API для маркетплейса скиллов\n\nНужны публичные и приватные эндпоинты для маркетплейса.\n\n## Эндпоинты\n\n```\nGET  /api/v1/skills              — публичные скиллы (фильтры: tag, level, price_model)\nGET  /api/v1/skills/:id          — детали скилла\nPOST /api/v1/skills              — создать скилл (auth required)\nPUT  /api/v1/skills/:id          — обновить (только автор)\nPOST /api/v1/skills/:id/publish  — отправить на ревью\nPOST /api/v1/skills/:id/install  — установить скилл себе\nGET  /api/v1/skills/my           — мои скиллы (созданн",
  "service": "telegram-bot",
  "type": "feat",
  "priority": "medium",
  "file_scope": [],
  "acceptance_criteria": [
    "Проблема из issue #8 устранена",
  ...
  "github_issue": {
    "number": 8,
    "url": "https://github.com/Rivega42/grandhub-feedback/issues/8",
    "author": "Rivega42"
  }
