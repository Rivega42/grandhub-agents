...
\n# TASK SPEC\n{
  "task_id": "TASK-20260314-GH25",
  "title": "feat(assistant-runtime): авто-суммаризация длинных диалогов",
  "description": "GitHub Issue #25: feat(assistant-runtime): авто-суммаризация длинных диалогов\n\nКогда история диалога превышает 30 сообщений — создавать summary и использовать его вместо полной истории.\n\n## Сервис\nservices/assistant-runtime/\n\n## Файлы\n- src/services/message-router.ts — добавить логику суммаризации\n- src/services/ai-client.ts — добавить функцию summarizeMessages()\n\n## Что сделать\n\nВ message-router.ts при сборке контекста:\n1. Получить историю сообщений ассистента\n2. Если сообщений > 30 — взять первые 25, вызвать summarizeMessages()\n3. summarizeMessages() делает LLM-запрос: S",
  "service": "assistant-runtime",
  "type": "feat",
  "priority": "medium",
  "file_scope": [],
  "acceptance_criteria": [
    "Проблема из issue #25 устранена",
  ...
  "github_issue": {
    "number": 25,
    "url": "https://github.com/Rivega42/grandhub-feedback/issues/25",
    "author": "Rivega42"
  }
