...
\n# TASK SPEC\n{
  "task_id": "TASK-20260314-GH22",
  "title": "fix(telegram-bot): починить lint и typecheck в /start онбординге (PR #87)",
  "description": "GitHub Issue #22: fix(telegram-bot): починить lint и typecheck в /start онбординге (PR #87)\n\nPR #87 создан агентом но не прошёл CI — lint и typecheck упали.\n\n## Сервис\nservices/telegram-bot/\n\n## Что сделать\n1. Посмотреть ветку agent/TASK-20260314-GH17\n2. Исправить все lint-ошибки и TypeScript ошибки в src/commands/start.ts\n3. Убедиться что pnpm typecheck и pnpm lint проходят\n\n## Ошибки CI\nLint fail + TypeCheck fail в PR #87: https://github.com/Rivega42/grandhub-v3/pull/87\n\nНужно прочитать текущий код в ветке agent/TASK-20260314-GH17, найти ошибки и исправить.\n\n## Критерии\n- pnpm lint пр",
  "service": "telegram-bot",
  "type": "fix",
  "priority": "medium",
  "file_scope": [],
  "acceptance_criteria": [
    "Проблема из issue #22 устранена",
  ...
  "timeout_minutes": 30,
  "cost_budget_usd": 2,
  "created_at": "2026-03-14T15:29:08.369Z",
  "github_issue": {
    "number": 22,
    "url": "https://github.com/Rivega42/grandhub-feedback/issues/22",
    "author": "Rivega42"
  }
