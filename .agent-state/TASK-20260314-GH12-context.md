...
\n# TASK SPEC\n{
  "task_id": "TASK-20260314-GH12",
  "title": "feat(telegram-bot): команда /skills — маркетплейс скиллов в боте",
  "description": "GitHub Issue #12: feat(telegram-bot): команда /skills — маркетплейс скиллов в боте\n\nРеализовать команду /skills в telegram-bot сервисе.\n\n## Сервис\nservices/telegram-bot/\n\n## Файлы\n- src/commands/skills.ts — новый файл (создать)\n- src/bot.ts — зарегистрировать команду /skills\n\n## Поведение\n\n### /skills\nПоказывает список доступных скиллов из таблицы skills (PostgreSQL).\nЗапрос: SELECT id, name, slug, description, icon, category FROM skills WHERE status = PUBLISHED AND \"isPublic\" = true ORDER BY \"installCount\" DESC\n\nФормат сообщения:\n\n\nКнопки inline keyboard: callback_data = skill",
  "service": "telegram-bot",
  "type": "feat",
  "priority": "medium",
  "file_scope": [],
  "acceptance_criteria": [
    "Проблема из issue #12 устранена",
  ...
  "timeout_minutes": 30,
  "cost_budget_usd": 2,
  "created_at": "2026-03-14T13:04:40.184Z",
  "github_issue": {
    "number": 12,
    "url": "https://github.com/Rivega42/grandhub-feedback/issues/12",
    "author": "Rivega42"
  }
