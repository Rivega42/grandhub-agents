...
\n# TASK SPEC\n{
  "task_id": "TASK-20260314-GH20",
  "title": "feat(telegram-bot): починить /help — заменить Markdown на HTML",
  "description": "GitHub Issue #20: feat(telegram-bot): починить /help — заменить Markdown на HTML\n\nКоманда /help отправляет Markdown-разметку которая не рендерится. Нужно исправить.\n\n## Сервис\nservices/telegram-bot/\n\n## Файлы\n- src/commands/help.ts или там где вызывается ctx.reply с /help текстом\n- Найти все места где используется parse_mode: Markdown и заменить на HTML\n\n## Что сделать\n\n1. Найти команду /help в исходниках\n2. Заменить все **bold** на <b>bold</b>\n3. Заменить все  на <code>code</code>\n4. Добавить parse_mode: HTML в ctx.reply()\n5. Обновить текст /help — добавить новые команды: /s",
  "service": "telegram-bot",
  "type": "feat",
  "priority": "medium",
  "file_scope": [],
  "acceptance_criteria": [
    "Проблема из issue #20 устранена",
  ...
  "timeout_minutes": 30,
  "cost_budget_usd": 2,
  "created_at": "2026-03-14T15:01:05.867Z",
  "github_issue": {
    "number": 20,
    "url": "https://github.com/Rivega42/grandhub-feedback/issues/20",
    "author": "Rivega42"
  }
