...
\n# TASK SPEC\n{
  "task_id": "TASK-20260314-GH4",
  "title": "feat(telegram-bot): собрать сервис и задеплоить",
  "description": "GitHub Issue #4: feat(telegram-bot): собрать сервис и задеплоить\n\nСервис telegram-bot не имеет dist/ и не запускается.\n\n## Задача\n1. Исправить TS ошибки компиляции в services/telegram-bot/\n2. Собрать: cd services/telegram-bot && pnpm build\n3. Убедиться что dist/index.js создан\n\n## Критерии приёмки\n- dist/index.js существует\n- pnpm build завершается без ошибок  \n- node dist/index.js стартует без FATAL (проверить 3 сек)\n",
  "service": "api-gateway",
  "type": "feat",
  "priority": "medium",
  "file_scope": [],
  "acceptance_criteria": [
    "Проблема из issue #4 устранена",
  ...
  "timeout_minutes": 30,
  "cost_budget_usd": 2,
  "created_at": "2026-03-14T09:14:35.662Z",
  "github_issue": {
    "number": 4,
    "url": "https://github.com/Rivega42/grandhub-feedback/issues/4",
    "author": "Rivega42"
  }
