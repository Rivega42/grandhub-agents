...
\n# TASK SPEC\n{
  "task_id": "TASK-20260314-GH16",
  "title": "feat(skill-registry): поиск и фильтрация в marketplace API (retry)",
  "description": "GitHub Issue #16: feat(skill-registry): поиск и фильтрация в marketplace API (retry)\n\nУлучшить GET /api/v1/marketplace — добавить query-параметры для поиска и фильтрации.\n\n## Сервис\nservices/skill-registry/\n\n## Файл\nsrc/routes/skills.ts — функция createMarketplaceRouter()\n\n## Что изменить\n\nВ обработчике GET /api/v1/marketplace добавить поддержку query params:\n- category — фильтр по полю category (точное совпадение)\n- tag — фильтр: tags массив contains это значение\n- q — поиск по полям name и description (case-insensitive, contains)\n- level — фильтр по числовому полю level\n- limit",
  "service": "skill-registry",
  "type": "feat",
  "priority": "medium",
  "file_scope": [],
  "acceptance_criteria": [
    "Проблема из issue #16 устранена",
  ...
  "timeout_minutes": 30,
  "cost_budget_usd": 2,
  "created_at": "2026-03-14T14:08:05.574Z",
  "github_issue": {
    "number": 16,
    "url": "https://github.com/Rivega42/grandhub-feedback/issues/16",
    "author": "Rivega42"
  }
