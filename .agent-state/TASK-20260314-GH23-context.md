...
\n# TASK SPEC\n{
  "task_id": "TASK-20260314-GH23",
  "title": "feat(telegram-bot): команда /stats — личная статистика использования",
  "description": "GitHub Issue #23: feat(telegram-bot): команда /stats — личная статистика использования\n\nДобавить команду /stats в telegram-bot.\n\n## Сервис\nservices/telegram-bot/\n\n## Файлы\n- src/commands/stats.ts — новый файл\n- src/bot.ts — зарегистрировать\n\n## Что показывать\n\n/stats выводит персональную статистику:\n- Всего сообщений отправлено\n- Установлено скиллов (из agent_skills)\n- Дней с момента регистрации\n- Самый используемый режим (если есть)\n\nФормат:\n📊 Твоя статистика\n💬 Сообщений: 142\n🛍 Скиллов: 3\n📅 С нами: 12 дней\n⭐ Любимый режим: Chain of Thought\n\nДанные брать из БД через существующи",
  "service": "telegram-bot",
  "type": "feat",
  "priority": "medium",
  "file_scope": [],
  "acceptance_criteria": [
    "Проблема из issue #23 устранена",
  ...
  "timeout_minutes": 30,
  "cost_budget_usd": 2,
  "created_at": "2026-03-14T15:29:08.368Z",
  "github_issue": {
    "number": 23,
    "url": "https://github.com/Rivega42/grandhub-feedback/issues/23",
    "author": "Rivega42"
  }
