...
\n# TASK SPEC\n{
  "task_id": "TASK-20260314-GH17",
  "title": "feat(telegram-bot): улучшить /start — онбординг нового пользователя",
  "description": "GitHub Issue #17: feat(telegram-bot): улучшить /start — онбординг нового пользователя\n\nСделать /start более информативным и вовлекающим.\n\n## Сервис\nservices/telegram-bot/\n\n## Файлы\n- src/commands/start.ts — изменить\n\n## Что сделать\n\nТекущий /start просто приветствует. Нужно сделать онбординг из 3 шагов:\n\nШаг 1 — Приветствие с кнопками:\nСообщение: Привет! Я твой AI-ассистент от GrandHub. Что хочешь делать?\nКнопки: [🛍 Посмотреть скиллы] [⚙️ Настройки] [💬 Просто поговорить]\n\nШаг 2 — При нажатии Посмотреть скиллы → показать топ-3 популярных скилла из БД с кнопкой [Открыть маркетплей",
  "service": "telegram-bot",
  "type": "feat",
  "priority": "medium",
  "file_scope": [],
  "acceptance_criteria": [
    "Проблема из issue #17 устранена",
  ...
  "github_issue": {
    "number": 17,
    "url": "https://github.com/Rivega42/grandhub-feedback/issues/17",
    "author": "Rivega42"
  }
