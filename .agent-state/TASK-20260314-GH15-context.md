...
\n# TASK SPEC\n{
  "task_id": "TASK-20260314-GH15",
  "title": "feat(telegram-bot): команда /settings — настройки ассистента",
  "description": "GitHub Issue #15: feat(telegram-bot): команда /settings — настройки ассистента\n\nДобавить команду /settings в telegram-bot.\n\n## Сервис\nservices/telegram-bot/\n\n## Файлы\n- src/commands/settings.ts — новый файл\n- src/bot.ts — зарегистрировать\n\n## Функционал\n\n/settings показывает меню:\n- Имя ассистента (текущее, кнопка изменить)\n- Язык ответов (RU / EN, переключатель)\n- Стиль общения (Формальный / Нейтральный / Дружелюбный)\n- Мои скиллы (сколько установлено, ссылка на /myskills)\n\nКаждый пункт — inline кнопка с callback_data = settings:{field}:{value}.\n\nПри нажатии на изменение —",
  "service": "telegram-bot",
  "type": "feat",
  "priority": "medium",
  "file_scope": [],
  "acceptance_criteria": [
    "Проблема из issue #15 устранена",
  ...
  "timeout_minutes": 30,
  "cost_budget_usd": 2,
  "created_at": "2026-03-14T13:06:10.072Z",
  "github_issue": {
    "number": 15,
    "url": "https://github.com/Rivega42/grandhub-feedback/issues/15",
    "author": "Rivega42"
  }
