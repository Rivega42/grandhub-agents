...
\n# TASK SPEC\n{
  "task_id": "TASK-20260314-GH19",
  "title": "feat(assistant-runtime): пагинация в GET /messages",
  "description": "GitHub Issue #19: feat(assistant-runtime): пагинация в GET /messages\n\nДобавить пагинацию и фильтрацию в endpoint получения истории сообщений.\n\n## Сервис\nservices/assistant-runtime/\n\n## Файл\nsrc/routes/messages.ts — GET /:id/messages\n\n## Что добавить\n\nПринимать query params:\n- limit (default 20, max 100)\n- before — курсор (id сообщения, вернуть сообщения старше этого)\n- after — курсор (id сообщения, вернуть сообщения новее этого)\n\nОтвет:\n{\n  messages: [...],\n  hasMore: boolean,\n  nextCursor: string | null\n}\n\nCursor-based пагинация через поле createdAt + id.\n\n## Кри",
  "service": "assistant-runtime",
  "type": "feat",
  "priority": "medium",
  "file_scope": [],
  "acceptance_criteria": [
    "Проблема из issue #19 устранена",
  ...
  "github_issue": {
    "number": 19,
    "url": "https://github.com/Rivega42/grandhub-feedback/issues/19",
    "author": "Rivega42"
  }
