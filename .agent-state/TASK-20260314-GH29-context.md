...
\n# TASK SPEC\n{
  "task_id": "TASK-20260314-GH29",
  "title": "feat(gha): LLM Orchestrator v2 — декомпозиция задач через claude-opus-4-6",
  "description": "GitHub Issue #29: feat(gha): LLM Orchestrator v2 — декомпозиция задач через claude-opus-4-6\n\nСоздать agents/orchestrator-v2.ts. НЕ трогать orchestrator.ts.\n\nСервис: grandhub-agents (корень /opt/grandhub-agents/)\n\nЧто делает:\n1. Принимает Feature (title + description)\n2. LLM (claude-opus-4-6 через localhost:18789) декомпозирует на 2-4 SubTask\n3. Последовательно запускает coder.ts для каждого SubTask через spawnSync\n4. После каждого Coder — LLM-ревью diff (сам оркестратор, не отдельный reviewer)\n5. Если ревью passed — следующий SubTask\n6. Если failed — retry Coder с feedback (max 2)\n7. По",
  "service": "telegram-bot",
  "type": "feat",
  "priority": "medium",
  "file_scope": [],
  "acceptance_criteria": [
    "Проблема из issue #29 устранена",
  ...
  "timeout_minutes": 30,
  "cost_budget_usd": 2,
  "created_at": "2026-03-14T16:19:02.247Z",
  "github_issue": {
    "number": 29,
    "url": "https://github.com/Rivega42/grandhub-feedback/issues/29",
    "author": "Rivega42"
  }
